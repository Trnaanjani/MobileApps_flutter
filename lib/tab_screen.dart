          ...
          return GestureDetector(
            ...
            child: Card(
              ...
              child: Column(
                ...
                children: [
                  Icon(item['icon'], size: 50.0, color: Color.fromARGB(255, 170, 223, 250)), // Ubah warna ikon di sini
                  SizedBox(height: 8.0),
                  Text(
                    item['label'],
      ...
      child: Column(
        ...
        children: [
          ...
          ListTile(
            ...
            subtitle: Text('Triana Anjani'),
          ),
          
          ListTile(
            leading: Icon(Icons.cake),
            title: Text('Tanggal Lahir'),
            subtitle: Text('3 Januari 2006'),
        ),
        
          ListTile(
            leading: Icon(Icons.book),
            title: Text('Jurusan'),
            subtitle: Text('Pengembangan Perangkat Lunak Dan Gim'),
        ),
        ],
      ),
    );
